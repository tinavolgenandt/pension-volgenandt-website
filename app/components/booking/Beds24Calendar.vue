...
const showCalendar = computed(() => isClient && isAllowed('booking'))

// Initialize calendar widget when scripts are loaded and container is mounted
watch(
