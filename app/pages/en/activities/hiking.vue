...
useHead({
  htmlAttrs: { lang: 'en' },
  link: [
    { rel: 'canonical', href: `${siteUrl}/en/activities/hiking/` },
    {
      rel: 'alternate',
      hreflang: 'de',
      href: `${siteUrl}/aktivitaeten/wandern/`,
    },
    {
      rel: 'alternate',
      hreflang: 'en',
      href: `${siteUrl}/en/activities/hiking/`,
    },
    {
      rel: 'alternate',
      hreflang: 'x-default',
...
<template>
  <div v-if="activity">
    ...
    <SharedPageBanner
      ...
      title="Hiking in the Eichsfeld"
      subtitle="Discover trails in the area"
    />
            ...
            <div class="flex flex-wrap items-start justify-between gap-4">
              <div class="flex-1">
                <h3 class="flex items-center gap-2 font-serif text-lg font-semibold text-sage-900">
                  <Icon name="ph:mountains-duotone" class="size-6 text-sage-600" />
                  {{ route.name }}
                </h3>
    ...
    >
      <div class="mx-auto max-w-3xl text-center">
        ...
        <p class="mb-8 text-sage-700">Find more hiking tours in the Eichsfeld on these portals:</p>
    ...
    <!-- Soft CTA -->
    <SharedSoftCta text="Need hiking tips? We know the best trails." />

    <!-- Booking CTA -->
    <SharedBookingCta text="Return to cosy rooms after your hike" button-text="View rooms" />
  </div>
</template>
