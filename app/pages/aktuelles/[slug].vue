...
const heroImageSchema = article.value.heroImageAiGenerated
  ? {
      ...
      creditText: article.value.heroImageCredit || 'KI-generierte Visualisierung',
...
if (faqItems.length) {
  schemaItems.push({
    '@type': 'FAQPage',
    '@id': `https://www.pension-volgenandt.de/aktuelles/${article.value.slug}/#faq`,
...
<template>
  <div v-if="article">
    ...
    <SharedSoftCta :text="t('news.articleQuestion', locale)" />
