...
const included = [
  {
    ...
    text: 'Für Ihr Festwochenende buchen Sie die komplette Pension exklusiv – alle Zimmer und Ferienwohnungen für bis zu 18 Übernachtungsgäste. Keine anderen Gäste, kein Gastgeber vor Ort: völlige Privatsphäre.',
  },
  {
    icon: 'ph:tree-duotone',
    title: 'Unser Garten als Festplatz',
    text: 'Ein weitläufiger, gepflegter Garten im Eichsfeld – idyllisch und mitten im Grünen, auf Wunsch mit Festzelt.',
  },
  {
  ...
  <div>
    ...
    <section class="mx-auto max-w-3xl px-6 py-12 text-center md:py-16">
      ...
      <p class="mt-4 text-lg leading-relaxed text-sage-800">
        ...
        direkt vor Ort – und wir verreisen, damit Sie völlig ungestört feiern können. Dazu ein
    ...
    <section class="bg-cream px-6 py-12 md:py-16">
      <div class="mx-auto max-w-4xl">
        ...
        <p class="mx-auto mt-8 max-w-2xl text-center text-sm leading-relaxed text-sage-600">
          ...
          Partner-Caterer richtet seine Küche in der Garage ein, Strom für Musik und Technik ist
          vorhanden – und Ihre Feier ist umfassend abgesichert.
        </p>
      </div>
    </section>
    ...
    <section class="bg-waldhonig-50 px-6 py-12 md:py-16">
      <div class="mx-auto max-w-2xl text-center">
        ...
        <p class="mt-3 text-sage-700">
          Rufen Sie uns an oder schreiben Sie uns – wir beraten Sie gerne zu Ihrer Feier.
        </p>
        <div class="mt-6 flex flex-wrap items-center justify-center gap-4">
          <a
            :href="`tel:${appConfig.contact.phone}`"
            class="inline-flex items-center gap-2 rounded-lg bg-waldhonig-500 px-6 py-3 text-base font-semibold text-white transition-colors hover:bg-waldhonig-600"
          >
          ...
          <a
            ...
            class="inline-flex items-center gap-2 rounded-lg border border-sage-300 px-6 py-3 text-base font-medium text-sage-700 transition-colors hover:bg-sage-100"
          >
            <Icon name="ph:envelope-simple-duotone" class="size-5" />
            E-Mail schreiben
          </a>
        </div>
      </div>
